                    ...
                    steps {
                        script {
                            dir("apps"){
                                ...
                                changeddirs = changeddirs + sh(script: "ls -l | awk '/^d/ {print \$9}'",returnStdout: true).split('\n')
                            }
                        }
                    }
                }
                    ...
                    steps {
                        script {
                            dir("apps"){
                                ...
                                changeddirs = changeddirs + sh(script: "git diff --name-only main origin/main |cut -d/ -f1|uniq",returnStdout: true).split('\n')
                            }
                        }
                    }
                }
